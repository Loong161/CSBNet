...
class MIRNet(nn.Module):
    def __init__(self, in_channels=3, out_channels=3, n_feat=24, kernel_size=3, stride=2, n_RRG=2, n_MSRB=2, height=3, width=2, bias=False):
...
#     def __init__(self, nChannels, growthRate, reduction, bias, act, kernel_size):
#         super(make_dense, self).__init__()
#         self.conv = nn.Conv2d(nChannels, growthRate, kernel_size=kernel_size, padding=(kernel_size - 1) // 2,
#                               bias=False)
#         self.cab = CAB(nChannels, kernel_size, reduction, bias, act)
#
#     def forward(self, x):
#         out = F.relu(self.conv(self.cab(x)))
...
# class RDB(nn.Module):
#     def __init__(self, nChannels, nDenselayer, growthRate, kernel_size, reduction, bias, act):
#         super(RDB, self).__init__()
#         nChannels_ = nChannels
#         modules = []
#         for i in range(nDenselayer):
#             modules.append(make_dense(nChannels_, growthRate, reduction, bias, act, kernel_size))
